...
def plotdata(*args):
		...
		ax1B.set_ylabel('OES integrated intensity', color='w')
		ax2B.set_xlabel('time', color='w')
				
		
		legend = ax1B.legend(bbox_to_anchor=(0.9, 1.1), loc='upper right', borderaxespad=0., shadow=True, labelspacing=0, numpoints=1)
		...
		#plt.title('OES zones ' + zoneChoices[0] + ' - ' + zoneChoices[0], color='w')
		#fig.canvas.set_window_title('OES zone ' + zoneToPlot)
